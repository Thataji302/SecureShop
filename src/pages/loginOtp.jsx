  ...
  const signOtp = async () => {
    ...
    try {
      ...
      if (response.result.res === "password not set") {
        ...
        history.push("/generatepassword/?id=" + response.result.userid);
    ...
    <>
      <div className="login-section">
        ...
        <div className="signin-wrapper">
          <a href="/"><img className="logo" src={imageCloudfront + "propertyCalculator/images/brand-logo.png"} /></a>
          ...
          <div className="mt-1 text-center"><p>� 2024 Fusion Finance.</p></div>
        </div>
      </div>
    </>
  );
