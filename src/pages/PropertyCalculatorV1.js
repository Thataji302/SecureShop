...
const PropertyCalculatorV1 = (props) => {
    ...
    useEffect(() => {
        ...
        if (calculationValues) {
            setOpenPopup(true)
            setCalculationValues(calculationValues)
    ...
    const handleInputChange = (event) => {
        ...
        // if (name == "average_eviction_days" || name == "average_rehab_days" || name == "average_listing_days" || name == "average_escrow_days") {
        //     let days = parseFloat(value.average_eviction_days) + parseFloat(value.average_rehab_days) + parseFloat(value.average_listing_days) + parseFloat(value.average_escrow_days);
    ...
    const inputCalculation = () => {
        ...
        if ((inputValue === "")) {
            ...
            var assum_hold_days = parseFloat(dayValue.average_eviction_days) + parseFloat(dayValue.average_rehab_days) + parseFloat(dayValue.average_listing_days) + parseFloat(dayValue.average_escrow_days);
            ...
            let totalCosts = (buyer_sales_comm_new_calc) + (seller_sales_comm_new_calc) + (sale_transferr_new_calc) + (dispositionfee_new_calc) + (escrow_new_calc) + (title_new_calc) + (insturance_calc) + (hold_property_tax_calc) + (utility_calc) + parseInt(inputValue.warranty) + parseInt(inputValue.locksmith) + (hoa_hold_calc) + (srdebt_intrate_calc) + parseInt(inputValue.title_taxes_due_new) + (sr_debt) + parseInt(inputValue.title_lien_amount) + parseInt(inputValue.eviction_cashforkeys_new) + parseInt(inputValue.estimated_rennovation_expense) + parseInt(inputValue.misc);
            ...
            let psf_new;
            let projected_profit = ((ar_value * roc) / 100);
            ...
            // }
            var max_bid = (psf_new - projected_profit) - totalCosts;
            // console.log('max_bid max_bid max_bid', max_bid)
    ...
    // console.log("average_eviction_days", dayValue?.average_eviction_days)
    // console.log("dayValue?.average_rehab_days", dayValue?.average_rehab_days)
    // console.log("dayValue?.average_listing_days", dayValue?.average_listing_days)
    // console.log("dayValue?.average_escrow_days", dayValue?.average_escrow_days)
        ...
        <div className="property_calculator">
            ...
            <div className="estimate_calculator">
                <div className="container">
                    <div className="d-flex align-items-center justify-content-between property_title">
                        <h3>Property Estimate Calculator</h3>
                    ...
                    <div className="content_block">
                        ...
                        <div className="right">
                            <div className="row">
                                ...
                                <div className="col-5">
                                    <div className="form-group">
                                        <label for="example-text-input" className="col-form-label">Market Value $</label>
                                ...
                                <div className="col-5">
                                    <div className="form-group">
                                        <label for="example-text-input" className="col-form-label">Listing Price $</label>
                                ...
                                <div className="col-5">
                                    <div className="form-group">
                                        <label for="example-text-input" className="col-form-label">Insurance /Month $ </label>
                                ...
                                <div className="col-5">
                                    <div className="form-group">
                                        <label for="example-text-input" className="col-form-label">Eviction Costs $</label>
                                ...
                                <div className="col-5">
                                    <div className="form-group">
                                        <label for="example-text-input" className="col-form-label">Renovation Costs $</label>
                ...
                <div className="custom_popup result_popup">
                    <div className="popup_content">
                            ...
                            <div className="row">
                                ...
                                {/* <div className="col-8">
                                    <div className="form-group">
                                        ...
                                        <p>{calculationValues?.proforma_profit}</p>
                                    </div>
                                </div>
                                <div className="col-8">
                                    <div className="form-group">
                                ...
                                <div className="col-8">
                                    <div className="form-group">
                                        ...
                                        <p>{calculationValues?.master_inv_profit}</p>
                                    </div>
                                </div>
                                <div className="col-8">
                                    <div className="form-group">
                                ...
                                {/* <div className="col-8">
                                    <div className="form-group">
                                        ...
                                        <div className="d-flex value_block">
                                            ...
                                            <p>{calculationValues?.buy_transfer_new_calc}</p>
                                        </div>
                                    </div>
                                </div> */}
                                <div className="col-8">
                                ...
                                {/* <div className="col-8">
                                    <div className="form-group">
                                        ...
                                        <div className="d-flex value_block">
                                            ...
                                            <p>{calculationValues?.acqfee_new_calc}</p>
                                        </div>
                                    </div>
                                </div> */}
                                {/* <div className="col-8">
                                    <div className="form-group">
                                        ...
                                        <div className="d-flex value_block">
                                            ...
                                            <p>{calculationValues?.developmentfee_new_calc}</p>
                                        </div>
                                    </div>
                                </div> */}
                                <div className="col-8">
                        ...
                        <div className="popup_footer">
                            ...
                            <button className="register" onClick={e => saveResults(e)}><span className="material-symbols-outlined"> calculate </span>Save Calculation</button>
                        </div>
                    </div>
                </div>}
            {success &&
...
export default PropertyCalculatorV1;
