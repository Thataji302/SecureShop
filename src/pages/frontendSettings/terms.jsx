...
const urlLink = lambda + '/useractivity?appname=' + appname + (previousId ? "&previousid=" + previousId : "");
     ...
     const handleMenu = () => {
        ...
        const token = localStorage.getItem("token")
         axios({
             method: 'GET',
             url: lambda + '/menus?appname=' + appname + '&menuid=100006&token=' + token,
         })
             .then(function (response) {
                             ...
                             <div className="row mb-4 breadcrumb">
                                 <div className="col-lg-9">
                                     <div className="d-flex align-items-center">
                                         <div>
                                             <h4 className="mb-2 card-title">TERMS settings</h4>
                                             <p className="menu-path">Front End Settings / <b>TERMS settings</b></p>
                                         </div>
                             ...
                             {value.length > 0 ? 
                                 ...
                                 <div className="form-block">
                                     <div>
                                         ...
                                         <button style={{marginTop:"20px"}} className="btn btn-primary ml-25 border_button" type="button" onClick={handleUpdate}><span className="material-symbols-outlined"> save </span>Update</button>
                                     </div>
