...
const urlLink = lambda + '/useractivity?appname=' + appname + (previousId ? "&previousid=" + previousId : "");
    ...
    const validate = (e, item) => {
        ...
        catogoryFields.forEach(function (item) {
            ...
            if (item.mandatory && item.name != 'item' && item.name != 'category' && item.name != 'landscapeimage' && item.name != 'portraitimage' && (!item.mappedKey || item.mappedKey == "" || item.mappedKey == undefined)) {
        ...
        if (contentFlag === false) {
            mappedData.forEach(function (item) {
                ...
                if (item.landscapeimage === undefined && item.portraitimage === undefined) {
                    error["portraitimage"] = "portraitimage is required";
                    error["landscapeimage"] = "landscapeimage is required";
                    formIsValid = false;
                }
    ...
    // console.log("catogoryFields", catogoryFields)
    // console.log("sheetKeys", sheetKeys.sort())
    return (
        <>
