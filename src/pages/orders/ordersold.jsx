...
const Orders = () => {
    ...
    const columns = [
        ...
        {
            name: "Total Items",
            selector: (row) => row.productspecification && row.productspecification.quantity,
        },
        {
            name: "Created Date",
...

        {
            ...
            selector: (row) => row.wholesalername,
        },
        {
            name: "Price ($)",
            selector: (row) => {
                const price = row.totalprice;
...

        {
            ...
            cell: (row) => (
                <div className="d-flex justify-content-between">
                    <a onClick={(e) => handleViewOrder(e, row.orderid, row.ordertype)}
    ...
    const handleDelete = (e) => {
        setIsLoading(true)
        axios.delete(lambda + '/deleteorder?appname=' + appname + '&userid=' + deleteId + '&token=' + localStorage.getItem("token"))
            .then(response => {
    ...
    const handleViewOrder = (e, id, type) => {
                                            ...
                                            {subValDashboard && subValDashboard.add && subValDashboard.add.display === true &&
                                                <div className="dropdown">
                                                    ...
                                                    <ul className="dropdown-menu">
                                                        ...
                                                        <li><button className="dropdown-item" href="#" onClick={() => handleClick("spacoverslifts")}>spa cover lifts</button></li>
                                                        <li><button className="dropdown-item" href="#" onClick={() => handleClick("spaaccessories")}>spa accessories</button></li>
                                                    </ul>
                                                </div>
                                            }
                                        </div>
                    ...
                    <div className="modal-body enquiry-form">
                        <div className="container">
                            ...
                            <div className="popup-footer">
                                <button className="fill_btn yellow-gradient" data-bs-toggle="modal" data-bs-target="#recommendModal" onClick={e => handleDelete()}> {isLoading ? (<img src="https://spacovers.imgix.net/spacoversdev/common/images/rotate_right.svgrotate_right.svg" className="loading-icon" />) : null}Yes, Delete</button>
                            </div>
                        </div>
                    </div>
