   ...
   const keyForRerender = `${rowsPerPage}_${data.length}`;
    const columns = [
        ...
        },
        {
            ...
            selector: row => row?.clientData?.[0]?.personalemail ?? '',
            sortable: true,
        },
...
const urlLink = lambda + '/useractivity?appname=' + appname + (previousId ? "&previousid=" + previousId : "");
 ...
 {showSessionPopupup && <SessionPopup />}
             <div id="layout-wrapper">
                 <Header />
                 <Sidebar />
                { click ?  (<ViewClientSessions data={viewContact} click={click} setClick={setClick}  />) :
                                 ...
                                 <div className="col-lg-12">
                                     <div className="d-flex align-items-center">
                                         <div className="flex-grow-1">
                                             <h4 className="mb-2 card-title">Client Sessions Report</h4>
                                         </div>
                                     </div>
                                 </div>
                             </div>
